...
struct SyclImplementationData {
    ...
    SyclImplementationData() {
    }
    ~SyclImplementationData() {
   }
};

SyclWaveSimulation::SyclWaveSimulation() = default;
SyclWaveSimulation::SyclWaveSimulation(SyclWaveSimulation&&)  noexcept = default;
SyclWaveSimulation& SyclWaveSimulation::operator=(SyclWaveSimulation&&) = default;
SyclWaveSimulation::~SyclWaveSimulation() = default;

SyclWaveSimulation SyclWaveSimulation::from_cpu_sim(const fs::path& cp, const WaveSimulation& source) {
    SyclWaveSimulation ans;
    ...
    // ans.impl = std::make_unique<SyclImplementationData>();

    return ans;
}

void SyclWaveSimulation::append_u_fields() {
    if (h5) {
        h5.append_u(u);
    }
}
...
void SyclWaveSimulation::run(int n) {
    for (int i = 0; i < n; ++i) {
